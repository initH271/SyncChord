            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="p-0">
                    ...
                    <div className="px-4 pb-4 flex flex-col gap-y-2">
                                    ...
                                    <DialogContent>
                                        ...
                                        <form className="space-y-4" onSubmit={handleEdit}>
                                            <Input value={newName} disabled={UpdatingWorkspace}
                                                   ...
                                                   placeholder="新的工作空间名称"/>
                                            <DialogFooter>
                                                <DialogClose asChild>
                                                    <Button disabled={UpdatingWorkspace} className=""
                                                            variant={"outline"}>
                                                        取消
                                                    </Button>
                                                </DialogClose>
                                                <Button disabled={UpdatingWorkspace} type="submit" className=""
                                                        variant={"default"}>
                                                    确认
                                                </Button>
                                            </DialogFooter>
                        ...
                        <button disabled={removingWorkspace} onClick={handleRemove}
                                className="flex items-center justify-end gap-x-2 px-5 py-4 rounded-lg cursor-pointer border hover:bg-gray-50 text-rose-600">
